...
class AppModule {
    ...
    @Provides
    @Singleton
    fun provideSettingsDao(creditCardAppDatabase: CreditCardManagerDatabase) =
        creditCardAppDatabase.settingsDao()

    @Provides
    @Singleton
    fun provideSettingsRepository(settingsDao: SettingsDao) =
